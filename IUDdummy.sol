...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2A19F1cE1aD3C53683C55d017Fb11e9db0C86140;
...
contract IUD is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xca749b28cFceC0E2892C0666C1976319421f761f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 266666666 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Investing Union";
    string private _symbol = "IUD";
    ...
    uint256 public _maxTxAmount = 2666666 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 266666 * 10**18;
